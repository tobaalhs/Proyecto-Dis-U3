...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        if (backendCatalogUrl != null) {
            System.out.println("URL para backend-ratings cargada: " + backendCatalogUrl);
            ...
            System.err.println("No se pudo cargar la URL de backend-ratings desde el archivo links.json.");
        }
    }
